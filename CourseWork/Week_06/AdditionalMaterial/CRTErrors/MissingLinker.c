...
//
// Incorrect compilation and execution:
// gcc -Wall -g -pg MissingLinker.c -o MissingLinker.x
//
// Corret compilation and execution:
// gcc -Wall -g -pg MissingLinker.c -lm -o MissingLinker.x
// ./MissingLinker.x
