...
\begin{equation}
T_{n+1} = \alpha T_{n} + \beta \Delta t\label{EQ2}
\end{equation}
where $\alpha = 1 - k\Delta t$ and $\beta = k\Delta tT_{room}}$
...
\begin{figure}[ht!]
	\centering
	\includegraphics[height=120mm,width=160mm]{Error.pdf}
	\caption{Error vs Number of points \label{overflow}}
\end{figure}

\begin{figure}[ht!]
	\centering
	\includegraphics[height=120mm,width=160mm]{pi.pdf}
