...
// gcc -g -Wall -fopenmp MonteCarloPi_p_02.c -o MonteCarloPi_p_02.x -lm
//
// export OMP_NUM_THREADS=2 (or 4 or 8 or 16, as appropriate)
// ./MonteCarloPi_p_02.x
...
int main(int argc, char **argv) {
  ...
  #pragma omp parallel shared(R, dart_chunk, n_circle) private(thread_id, i, x, y, dart_llimit, dart_ulimit) 
  {
    // Thread ID
    thread_id = omp_get_thread_num();
